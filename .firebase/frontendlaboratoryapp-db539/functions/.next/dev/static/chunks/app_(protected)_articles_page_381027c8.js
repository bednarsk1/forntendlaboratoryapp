...
function ArticlesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArticlesPage.useEffect": ()=>{
            const fetchArticles = {
                "ArticlesPage.useEffect.fetchArticles": async ()=>{
                    try {
                        // 🔥 ZAPYTANIE FIRESTORE
                        ...
                        const data = snapshot.docs.map({
                            "ArticlesPage.useEffect.fetchArticles.data": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["ArticlesPage.useEffect.fetchArticles.data"]);
                        setArticles(data);
                    } catch (err) {
            ...
            }["ArticlesPage.useEffect.fetchArticles"];
            fetchArticles();
        }
    }["ArticlesPage.useEffect"], [
        user
...
_s(ArticlesPage, "L+Ar4sq0jvdt2d6imlVaeZF+z4k=", false, function() {
    return [
