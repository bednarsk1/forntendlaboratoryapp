...
function Protected({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "Protected.useLayoutEffect": ()=>{
            if (!user) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(`/user/signin?returnUrl=${returnUrl}`);
            }
        }
    }["Protected.useLayoutEffect"], []);
...
_s(Protected, "k9d8w4ygh2/6pO0LCpNhA1qAymc=", false, function() {
    return [
